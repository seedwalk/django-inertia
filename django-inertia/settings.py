"""
Django settings for django-inertia project.
...
MIDDLEWARE = [
    ...
    "django-inertia.middleware.DataShareMiddleware",
]

ROOT_URLCONF = "django-inertia.urls"
...
WSGI_APPLICATION = "django-inertia.wsgi.application"
